...
export function AppSidebar({ children }: Props): JSX.Element {
    ...
    <Sidebar collapsible="icon" variant="floating">
      <SidebarHeader>
        {open ? (
          ...
          >
            <h1 className="text-primary/80 text-2xl font-bold">D</h1>
          </Link>
        )}
      </SidebarHeader>
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <Link
                      href={item.url}
                      className={cn({
                        "!bg-background": pathname === item.url,
                      })}
                    >
                      <item.icon />
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem
                className={cn("", { "flex justify-center": !open })}
              >
                <Link href="/create">
